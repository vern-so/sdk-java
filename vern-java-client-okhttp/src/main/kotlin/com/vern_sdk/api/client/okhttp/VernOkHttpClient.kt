...
package com.vern_sdk.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.vern_sdk.api.client.VernClient
import com.vern_sdk.api.client.VernClientImpl
...
/**
 * A class that allows building an instance of [VernClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class VernOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [VernClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): VernClient = builder().fromEnv().build()
    }

    /** A builder for [VernOkHttpClient]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.vern_sdk.api.core.jsonMapper]. The default is usually sufficient and
         ...
         *
         * Defaults to the production environment: `https://vern.so/api/v1`.
         */
        ...
        /**
         * Returns an immutable instance of [VernClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VernClient =
            VernClientImpl(
                clientOptions
                    .httpClient(
