...
dependencies {
    testImplementation(project(":vern-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../vern-java-core/src/main/resources/META-INF/proguard/vern-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.vern_sdk.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../vern-java-core/src/main/resources/META-INF/proguard/vern-java-core.pro",
