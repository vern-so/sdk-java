...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.vern_sdk.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.vern_sdk.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.vern_sdk.api.** {
    <init>(...);
